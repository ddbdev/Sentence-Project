...
import it.cgmconsulting.mssentence.config.EurekaInstanceReceiver;
...
public class RequestController {
    ...
    @Autowired
    public RequestController(FeignVerb feignVerb, FeignSubject feignSubject, FeignObject feignObject) {
